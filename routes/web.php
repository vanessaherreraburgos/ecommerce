...
*/
	...
	Route::get('catalogo_productos', ['uses'=>'productos\ProductosController@index','as'=>'catalogo_productos']);

	Route::get('/home', 'productos\ProductosController@index')->name('home');	

	Route::get ('logout',['uses'=>'Auth\LoginController@logout','as'=>'logout']);

	Route::get('iniciar_sesion', ['uses'=>'Auth\LoginController@iniciarSesion','as'=>'iniciar_sesion']);

	Route::get('crear_usuario', ['uses'=>'Auth\RegisterController@vistaRegistro','as'=>'crear_usuario']);

	Route::post('guardar_registro', ['uses'=>'Auth\RegistroController@guardarRegistro','as'=>'guardar_registro']);
	

	/**
     *--------------------------------------------
     * RUTA PARA DATATABLE DE PRODUCTOS
     *--------------------------------------------    
    */
	Route::get('productos/datatable', ['uses'=>'productos\ProductosController@dataTableProducto','as'=>'productos/datatable']);
     ...
     *--------------------------------------------    
    */
	//Route::get('/cart-add/{producto_id}','carritoCompras\CarritoController@add')->name('cart.add');
	Route::get('cart.add', ['uses'=>'carritoCompras\CarritoController@add','as'=>'cart.add']);
	
	//Route::get('/cart-checkout','carritoCompras\CarritoController@cart')->name('cart.checkout');
	Route::get('cart.checkout', ['uses'=>'carritoCompras\CarritoController@listar_carrito','as'=>'cart.checkout']);

	//Route::post('/cart-clear',  'carritoCompras\CarritoController@clear')->name('cart.clear');
	Route::get('cart.clear', ['uses'=>'carritoCompras\CarritoController@clear','as'=>'cart.clear']);

	//Route::post('/cart-removeitem',  'carritoCompras\CarritoController@removeitem')->name('cart.removeitem');
	Route::get('cart.removeitem', ['uses'=>'carritoCompras\CarritoController@removeitem','as'=>'cart.removeitem']);

	Route::get('procesar_compra', ['uses'=>'carritoCompras\CarritoController@procesarCompra','as'=>'procesar_compra']);

	Route::post('finalizar_compra', ['uses'=>'carritoCompras\CarritoController@FinalizarCompra','as'=>'finalizar_compra']);

	Route::get('pago_exitoso', ['uses'=>'carritoCompras\CarritoController@PagoExitoso','as'=>'pago_exitoso']);
