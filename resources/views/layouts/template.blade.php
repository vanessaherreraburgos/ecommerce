...
<head>
    ...
    <!-- Sweet Alert 1 -->
    <link href="{{ asset('/theme_inspinia/css/plugins/sweetalert1/sweetalert.css') }}" rel="stylesheet">
...
<body class="kuravaina-skin fixed-nav no-skin-config">
  ...
  <!-- Wrapper-->
    ...
    <!-- Sweet alert -->
    <script src="{{ asset('/theme_inspinia/js/plugins/sweetalert1/sweetalert.min.js') }}"></script>
